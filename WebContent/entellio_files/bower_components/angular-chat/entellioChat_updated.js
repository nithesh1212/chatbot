...
var entellioBaseUrl = "http://localhost:9090/ChatBot/chatServlet";
//var botId = '743f864f06de9ae157d51c60';
//var botUserName = "Dc_rm_devops_gx";
//var botPassword = "904CXR7Z";
...
var entellioURL = entellioBaseUrl;
...
chatApp.controller("chatController", function($scope, $location, $window, $filter, $rootScope) {
    ...
    $(".spinner").show();
        ...
        if (textEntered != '') {
			...
			console.log(params);
            $.ajax({
                url: entellioURL+"?val="+textEntered,
